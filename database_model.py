...
class Notification(db.Model):
    ...
    is_check_by_manager = db.Column(db.Boolean, default=0, nullable=True)
    is_check_by_employee = db.Column(db.Boolean, default=0, nullable=True)
    is_check_by_parent = db.Column(db.Boolean, default=0, nullable=True)
    is_check_by_delivery_boy = db.Column(db.Boolean, default=0, nullable=True)
